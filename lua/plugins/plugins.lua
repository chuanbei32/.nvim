...
-- Work Flow {
    ...
    inserts('ethanholz/nvim-lastplace', nil) -- 自动定位到上次离开位置
    inserts('jghauser/mkdir.nvim', nil) -- 自动创建缺失文件夹
    -- inserts('Pocco81/AutoSave.nvim') -- 自动保存文件
    -- inserts('airblade/vim-rooter') -- 自动设置/更改工作目录
    ...
    inserts('norcalli/nvim-colorizer.lua', 'nvim-colorizer.lua') -- 视觉颜色
